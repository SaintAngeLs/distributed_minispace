...
namespace Astravent.Web.Wasm.Areas.ApiLinkService;
...
public class ApiLinkService : IApiLinkService
{
    ...
    private void RegisterAliases()
    {
        ...
        RegisterPage("Combo Box", subtitle: "Go to Select", componentType: typeof(MudSelect<>));
        RegisterPage("Drag & Drop", subtitle: "Go to Drop Zone", componentType: typeof(MudDropZone<>));
        RegisterPage("Dropdown", subtitle: "Go to Select", componentType: typeof(MudSelect<>));
        ...
        RegisterPage("Typeahead", subtitle: "Go to Autocomplete", componentType: typeof(MudAutocomplete<>));
    }
