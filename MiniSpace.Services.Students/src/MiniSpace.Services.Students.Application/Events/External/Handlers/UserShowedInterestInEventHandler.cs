...
{
    public class UserShowedInterestInEventHandler : IEventHandler<UserShowedInterestInEvent>
    {
        ...
        public async Task HandleAsync(UserShowedInterestInEvent @event, CancellationToken cancellationToken)
        {
