...
public class User : AggregateRoot
{
    ...
    // New: Indicates whether the user's email has been verified.
    ...
    public User(
        ...
        bool isBanned,
        State state,
        IEnumerable<Guid> interestedInEvents,
        IEnumerable<Guid> signedUpEvents,
        string bannerUrl,
        IEnumerable<Education> education,
        IEnumerable<Work> work,
    ...
    {
        // Optionally validate description here
    }
