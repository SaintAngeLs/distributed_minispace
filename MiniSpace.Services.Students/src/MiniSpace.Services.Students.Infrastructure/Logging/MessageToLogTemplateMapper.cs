        ...
        private static IReadOnlyDictionary<Type, HandlerLogTemplate> MessageTemplates 
            => new Dictionary<Type, HandlerLogTemplate>
            {
                ...
                },
                {
                    ...
                    {
                        After = "Completed a registration for the student with id: {Id}."
                    }
                },
                {
                    typeof(ChangeUserState), new HandlerLogTemplate
                    {
                        After = "Changed a student with id: {Id} state to: {State}."
                    }
                },
                {
                    typeof(SignedUp), new HandlerLogTemplate
                    {
                        After = "Created a new student with id: {Id}."
                    }
                },
                {
                    typeof(UserShowedInterestInEvent), new HandlerLogTemplate
                    {
                        After = "A student with id: {Id} has been interested in the event with id: {EventId}."
                    }
                },
                {
                    typeof(UserCancelledInterestInEvent), new HandlerLogTemplate
                    {
                        After = "A student with id: {Id} has cancelled interest in the event with id: {EventId}."
                    }
                },
                {
                    typeof(UserSignedUpToEvent), new HandlerLogTemplate
                    {
                        After = "A student with id: {Id} has signed up for the event with id: {EventId}."
                    }
                },
                {
                    typeof(UserCancelledSignUpToEvent), new HandlerLogTemplate
                    {
                        After = "A student with id: {Id} has cancelled sign up for the event with id: {EventId}."
                    }
                },
                {
                    typeof(UserBanned), new HandlerLogTemplate
                    {
                        After = "A student with id: {Id} has been banned."
                    }
                },
                {
                    typeof(UserUnbanned), new HandlerLogTemplate
                    {
                        After = "A student with id: {Id} has been unbanned."
                    }
                }
            };
