...
{
    public class UserSignedUpToEventHandlerTest
    {
        private readonly UserSignedUpToEventHandler _userSignedUpToEventHandler;
        private readonly Mock<IUserRepository> _userRepositoryMock;
        private readonly Mock<IEventMapper> _eventMapperMock;
        private readonly Mock<IMessageBroker> _messageBrokerMock;

        public UserSignedUpToEventHandlerTest() 
        {
            _userRepositoryMock = new Mock<IUserRepository>();
            _eventMapperMock = new Mock<IEventMapper>();
            _messageBrokerMock = new Mock<IMessageBroker>();
            _userSignedUpToEventHandler = new UserSignedUpToEventHandler(
        ...
        public async Task HandleAsync_ValidEvent_ShouldUpdateReposytory()
        {
            ...
            var @event = new UserSignedUpToEvent(eventId, studentId);
            ...
            // Act & Assert
            Func<Task> act = async () => await _userSignedUpToEventHandler.HandleAsync(@event, cancelationToken);
