            ...
            => await WebHost.CreateDefaultBuilder(args)
                ...
                .Configure(app => app
                    ...
                    .UseDispatcherEndpoints(endpoints => endpoints
                        ...
                        .Get<PendingFriendAccept, FriendRequestDto>("friends/requests/{studentId}/accept")
                        .Get<PendingFriendDecline, FriendRequestDto>("friends/requests/{studentId}/decline")
                        .Post<InviteFriend, FriendDto>("friends/{studentId}/invite")
