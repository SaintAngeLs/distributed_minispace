...
{
    public class AddOrganizerToOrganizationHandlerTest
    {
        private readonly AddOrganizerToOrganizationHandler _addOrganizerToOrganizationHandler;
        ...
        public AddOrganizerToOrganizationHandlerTest()
        {
            _organizationRepositoryMock = new Mock<IOrganizationRepository>();
            _organizerRepositoryMock = new Mock<IOrganizerRepository>();
            _appContextMock = new Mock<IAppContext>();
            _messageBrokerMock = new Mock<IMessageBroker>();
            _addOrganizerToOrganizationHandler = new AddOrganizerToOrganizationHandler(
        ...
        public async Task HandleAsync_WithValidOrganizationAndAuthorised_ShouldUpdateOrganization()
        {
            ...
            var comand = new AddOrganizerToOrganization(rootOrganizationId, organizationId, organizerId);
            ...
            // Act
            await _addOrganizerToOrganizationHandler.HandleAsync(comand, cancelationToken);
        ...
        public async Task HandleAsync_WithoutAdminRole_ShouldThrowUnauthorizedAccessException()
        {
            ...
            // Act & Assert
            Func<Task> act = async () => await _addOrganizerToOrganizationHandler.HandleAsync(comand, cancelationToken);
