namespace MiniSpace.Services.Organizations.Core.Exceptions
{
    public class UserAlreadyInvitedException : DomainException
    {
        ...
        public UserAlreadyInvitedException(Guid userId, Guid organizationId) : base(
            $"User with ID: '{userId}' has already been invited to organization with ID: '{organizationId}'.")
        {
            UserId = userId;
